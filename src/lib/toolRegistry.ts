...
export const ALL_TOOLS: ToolEntry[] = [
  ...
  },
  {
    ...
    description: "Record screen, webcam & mic in-browser.",
    category: "creator",
    href: "/screen-recorder",
    emoji: "🖥️",
    keywords: ["screen", "recorder", "capture", "webcam", "microphone", "video", "record"],
    status: "Live",
    color: "#6A4C93",
    artClass: "tool-art-recorder",
    isPopular: true,
  },
  ...
  // ── Workplace Utilities ──
  {
    ...
    category: "workplace",
    href: "/workplaceutilities/pdf-page-manager",
    emoji: "📑",
    keywords: ["pdf", "page", "manager", "split", "rotate", "reorder", "delete"],
    status: "Live",
    color: "#2A9D8F",
    badge: "Split · Rotate",
    isPopular: true,
  ...
  },
  {
    ...
    name: "Reaction Time Reflex",
    description: "Test your lightning reflexes! Tap as fast as you can when the screen turns green.",
    category: "games",
    href: "/games/reaction-timer",
    emoji: "⚡",
    keywords: ["reaction", "time", "reflex", "speed", "fast", "game", "kids", "family"],
    status: "Live",
    color: "#EF4444",
    badge: "All Ages",
    isPopular: true,
  ...
  {
    id: "archetype-quiz",
    name: "Archetype Personality Profile",
    description: "Discover your primary archetype & balance (Strategist, Creator, Empath, Visionary, Realist, Catalyst) with a visual radar chart.",
    category: "personality",
    href: "/personality/archetype-quiz",
    emoji: "🎯",
    keywords: ["archetype", "personality", "quiz", "psychology", "radar", "profile", "mbti", "traits"],
    status: "Live",
    color: "#9C27B0",
    badge: "Radar Chart",
    isPopular: true,
  },
  {
    ...
    description: "Benchmark your visual, auditory, and selective reflexes with millisecond precision against global percentiles.",
    category: "personality",
    href: "/personality/reaction-timer",
    emoji: "⚡",
    keywords: ["reaction", "time", "reflex", "timer", "speed", "esports", "gaming", "benchmark"],
    status: "Live",
    color: "#EF4444",
