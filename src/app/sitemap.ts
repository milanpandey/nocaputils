...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const toolRoutes: MetadataRoute.Sitemap = [
        ...
        {
            url: `${baseUrl}/games/reaction-timer`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.7,
        },
        ...
        {
            url: `${baseUrl}/personality/rorschach-test`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.7,
        },
        {
            url: `${baseUrl}/personality/archetype-quiz`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/personality/reaction-timer`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/personality/color-quest`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.7,
        },
        ...
        {
            url: `${baseUrl}/workplaceutilities/archive-files`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.7,
        },
        {
            url: `${baseUrl}/workplaceutilities/pdf-page-manager`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/workplaceutilities/pdf-to-markdown`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/workplaceutilities/markdown-editor`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/workplaceutilities/markdown-to-pdf`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/workplaceutilities/markdown-table`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        ...
        {
            url: `${baseUrl}/developer-tools/jwt-decoder`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        ...
        {
            url: `${baseUrl}/developer-tools/diff-comparator`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
        {
            url: `${baseUrl}/developer-tools/hash-base64`,
            lastModified: new Date(),
            changeFrequency: 'monthly',
            priority: 0.8,
        },
